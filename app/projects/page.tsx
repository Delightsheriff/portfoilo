...
const projectsData: Project[] = [
  {
    ...
    description: "A hotel website for a fictional hotel",
    technologies: ["Next.Js", "Tailwind", "Supabase"],
    imageUrl: "/wild-oasis-website.PNG",
    githubUrl: "https://github.com/Delightsheriff/thewildoasis-customer-",
    liveUrl: "https://thewildoasis-customer.vercel.app/",
  },
  {
    id: "2",
    title: "The Wild Oasis Hotel Management System",
    description: "A hotel management system for a fictional hotel",
    technologies: ["React", "Styled Components", "Supabase"],
    imageUrl: "/wild-oasis-hotel-management.PNG",
    githubUrl: "https://github.com/Delightsheriff/wild-Oasis",
    liveUrl: "https://thewildoasisbydelight2.netlify.app/dashboard",
  },
  {
    id: "3",
    title: "A Library Stock Automation System",
    description:
      "A library stock automation system for the University of Port Harcourt Library",
    technologies: ["React", "Chakra UI", "Node.js"],
    imageUrl: "/library.PNG",
    githubUrl: "https://github.com/Delightsheriff/Library_stock-client-",
    liveUrl: "https://librarystock.netlify.app/",
  },
